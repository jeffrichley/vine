...
class TestAudioConfig:
    ...
    def test_create_music_config(self):
    ...
    def test_audio_validation_none_values(self):
    ...
    def test_audio_validation_zero_values(self):
    ...
    def test_audio_validation_empty_strings(self):
